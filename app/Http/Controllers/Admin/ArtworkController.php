...
class ArtworkController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Hero/mockup image (shown large in detail page)
        ...
        unset($data['image_name'], $data['hero_image_name'], $data['gallery_files'], $data['gallery_labels']);
    ...
    public function update(Request $request, Artwork $artwork)
    {
        ...
        unset($data['image_name'], $data['hero_image_name'], $data['gallery_files'], $data['gallery_labels'], $data['gallery_delete']);
