    ...
    <section class="tuc-why">
        <div class="tuc-why__inner">
            <div class="tuc-why__content">
                ...
                <p class="tuc-why__body">{{ $project->meta ?? $project->description ?? 'A polished project built for client storytelling, user conversion, and digital presentation.' }}</p>
            </div>
            <div class="tuc-why__quote-wrap">
                <blockquote class="tuc-why__quote">
                    <svg class="tuc-why__quote-icon" width="40" height="32" viewBox="0 0 40 32" fill="none">
                        <path d="M0 32V20C0 14.667 1.333 10.333 4 7C6.667 3.667 10.667 1.333 16 0L17.6 3.2C14.933 4.133 12.933 5.6 11.6 7.6C10.267 9.467 9.6 11.8 9.6 14.6H16V32H0ZM24 32V20C24 14.667 25.333 10.333 28 7C30.667 3.667 34.667 1.333 40 0L41.6 3.2C38.933 4.133 36.933 5.6 35.6 7.6C34.267 9.467 33.6 11.8 33.6 14.6H40V32H24Z" fill="currentColor" opacity="0.2"/>
                    </svg>
                    @if(!empty($project->tools))
                        <p>Tools used: {{ implode(', ', (array) $project->tools) }}</p>
                    @endif
                    <cite class="tuc-why__quote-cite">— {{ $siteSettings['brand_name'] ?? 'Keana' }}, Designer &amp; Developer</cite>
                </blockquote>
            </div>
        </div>
    </section>
            ...
            <div class="tuc-process__right">
                <div class="tuc-process__steps">
                    ...
                    <div class="tuc-process__step">
                        ...
                        <div class="tuc-process__step-body">
                            <h4>Build &amp; Launch</h4>
                            <p>Pixel-perfect build with responsive breakpoints, animations, and performance optimization.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="tuc-next">
        <div class="tuc-next__inner">
            ...
            @else
                ...
                <p class="tuc-next__desc">Each project tells a different story. Browse the full portfolio to see what else has been crafted.</p>
