    ...
    <div class="seo-tools__inner">
        ...
        <div class="seo-tools__grid">
            @forelse($seoTools as $tool)
               {{-- Replace the existing icon block inside seo-tool-card --}}
    ...
    <div class="seo-projects__inner">
        ...
        <div class="seo-projects__list">
            ...
            @empty
                ...
                @foreach([
                    [
                        'num'=>'01','cat'=>'On-Page SEO','title'=>'Monte Carlo Technologies — Full SEO Audit',
                    ...
                    [
                        'num'=>'02','cat'=>'Content Strategy','title'=>'Keyword Research & Content Mapping',
                    ...
                    [
                        'num'=>'03','cat'=>'Technical SEO','title'=>'Core Web Vitals Optimization',
...
<section class="seo-cta">
    <div class="seo-cta__inner">
        <h2 class="seo-cta__title">Ready to rank higher?</h2>
        <p class="seo-cta__desc">Whether it's a full audit, keyword strategy, or ongoing SEO support — let's talk.</p>
        <a href="{{ route('contact') }}" class="btn btn--primary btn--arrow">
