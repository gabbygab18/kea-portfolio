...
@section('content')
    <section class="hero">
        <div class="hero__content">
            <h1 class="hero__title">{{ $siteSettings['hero_title'] ?? 'Working through the night to bring wise ideas to light.' }}</h1>
            <p class="hero__description">{{ $siteSettings['hero_description'] ?? 'Lorem ipsum dolor sit amet consectetur adipiscing elidolor mattis sit phasellus mollis sit aliquam sit nullam neques.' }}</p>
            <div class="hero__cta">
                <a href="{{ route('contact') }}" class="btn btn--primary btn--arrow">Get started<span class="btn__arrow">›</span></a>
    ...
    <section class="about">
        <div class="about__inner">
            ...
            <div class="about__content">
                ...
                <p class="about__description">{{ $siteSettings['about_description'] ?? 'Lorem ipsum dolor sit amet consectetur adipiscing eli mattis sit phasellus mollis sit aliquam sit nullam neque ultrices.' }}</p>
    ...
    <section class="services">
        <div class="services__inner">
            <div class="services__header">
                ...
                <p class="services__desc">{{ $siteSettings['services_description'] ?? 'Lorem ipsum dolor sit amet consectetur adipiscing eli mattis sit phasellus mollis sit aliquam sit nullam.' }}</p>
            </div>
    ...
    <section class="artworks">
        <div class="artworks__header">
            ...
            <p class="artworks__desc">Browse a selection of recent projects built with polished UI, strong storytelling, and thoughtful branding.</p>
        </div>
        ...
        <div class="artworks__footer">
            <a href="{{ route('artworks') }}" class="btn btn--primary btn--arrow">See more <span class="btn__arrow">›</span></a>
        </div>
    </section>
...
if (cards.length < SCROLL_THRESHOLD) {
    // ── STATIC MODE: centered grid, no scrolling ──
